 ...
 */
final class Version20200831084622 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, name VARCHAR(255) NOT NULL, base_price INT DEFAULT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
